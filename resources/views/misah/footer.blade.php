  ...
  <div class="container pt-5 pb-4">
      <div class="row g-5">
          <div class="col-lg-3 col-md-6">
              <a href="index.html">
                  <h3 class="text-white fw-bold d-block">UKM  <span class="text-secondary">Pendidikan riset dan teknologi ut bogor</span> </h3>
              </a>
          ...
          <div class="col-lg-3 col-md-6">
              <div class="mt-4 d-flex flex-column help-link">
                  <a href="" class="mb-2 text-white pt-5"><i class="fas fa-angle-right text-secondary me-2"></i>Dokumentasi</a>
                  <a href="" class="mb-2 text-white"><i class="fas fa-angle-right text-secondary me-2"></i>Seputar Maba</a>
                  <a href="" class="mb-2 text-white"><i class="fas fa-angle-right text-secondary me-2"></i>Div TIK</a>
                  <a href="" class="mb-2 text-white"><i class="fas fa-angle-right text-secondary me-2"></i>Div PENDIDIKAN</a>
                  <a href="" class="mb-2 text-white"><i class="fas fa-angle-right text-secondary me-2"></i>Sisi lain penristek</a>
              </div>
          </div>
          <div class="col-lg-3 col-md-6 ">
              ...
              <div class="text-white mt-4 d-flex flex-column contact-link">
                  ...
                  <a href="#" class="py-3 text-light border-bottom border-primary"><i class="fas fa-envelope text-secondary me-2"></i> ukmpenristekutbogor</a>
              </div>
          </div>
      </div>
      ...
      <div class="row">
          <div class="col-md-6 text-center text-md-start">
              <span class="text-light"><a href="#" class="text-secondary"><i class="fas fa-copyright text-secondary me-2"></i>Dibuat dengan </a><i class="bi bi-heart-fill text-danger"></i> Oleh div tik penristek</span>
          </div>
