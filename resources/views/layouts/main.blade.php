            ...
            <div class="container">
                <div class="d-flex justify-content-between topbar">
                    <div class="top-info">
                        ...
                        <small class=" ilang-mobile me-3 text-white-50"><a href="#"><i class="fas fa-envelope me-2 text-secondary "></i></a>ukmpenristekutbogor@gmail.com</small>
                    </div>
            ...
            <div class="container">
                <nav class="navbar navbar-dark navbar-expand-lg py-0">
                    ...
                    <a class="navbar-brand d-flex" href="#">
                        ...
                        <h3 class="mx-2 mt-2 text-white fw-bold">UKM <span class="text-secondary">PENRISTEK</span> </h3>
                      </a>
                    ...
                    <div class="collapse navbar-collapse bg-transparent" id="navbarCollapse">
                        <div class="navbar-nav ms-auto mx-xl-auto p-0">
                            <a href="/" class="nav-item nav-link {{ ($tittle=='UKM PENRISTEK UT BOGOR')? 'active': '' }} ">Beranda</a>
                            <a href="/tentang-kami" class="nav-item nav-link  {{ ($tittle=='Tentang Kami')? 'active': '' }}">Tentang kami</a>
                            <a href="/berita" class="nav-item nav-link {{ ($tittle=='Berita')? 'active': '' }}">Berita</a>
                            <a href="/dokumentasi" class="nav-item nav-link {{ ($tittle=='Dokumentasi')? 'active': '' }}">Dokumentasi</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle {{ ($tittle=='div')? 'active': '' }}" data-bs-toggle="dropdown">Divisi</a>
                                <div class="dropdown-menu rounded">
                                    <a href="/divtik" class="dropdown-item">DIVISI TIK</a>
                                    <a href="/divpendidikan" class="dropdown-item">DIVISI PENDIDIKAN</a>
                                </div>
                            </div>
                            <a href="/kontak" class="nav-item nav-link {{ ($tittle=='Kontak')? 'active': '' }}">Kontak & saran</a>
